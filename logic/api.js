                ...
                if (end.flightNum.toUpperCase().indexOf('MU') != -1) {
                    ...
                    rules[startPrice.tgqRuleId] = {
                        "adult": {
                            ...
                            "changeText": (changeText ? changeText : "").split("；")[0] + (changeText ? changeText : "").split("；")[1] + (changeText ? changeText : "").split("；")[2] + (changeText ? changeText : "").split("；")[3] + (changeText ? changeText : "").split("；")[4], //改签文本，必传
