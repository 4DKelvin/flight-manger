...
module.exports = {
    ...
    sendTicket: async function (order) {
        let data = {
            "context": {
                "version": "1.0.0",
                "sign": "27a497846e2648f98932b5635d68795c",
                "timestamp": 1507795181165,//时间戳，精确到毫秒
                "channel": "zhixing",//渠道
                "source": "Car",//来源
                "tag": "flight.national.afterservice.ticketNoUpdate"//接口tag名称标识
            },
            "data": Utils.encodeBase64(JSON.stringify({
